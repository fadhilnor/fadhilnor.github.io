!(function (t, e, i, n) {
  ...
  function _(t, e) {
    ...
    (e.eventType !== Pt && r.eventType !== Rt) ||
      ((s = t.prevDelta = { x: r.deltaX || 0, y: r.deltaY || 0 }), (n = t.offsetDelta = { x: i.x, y: i.y })),
    ...
    handler: function Se(t) {
      ...
      if ((e === Pt && (this.started = !0), this.started)) {
        ...
        e & (Rt | Mt) && i[0].length - i[1].length === 0 && (this.started = !1),
          this.callback(this.manager, e, { pointers: i[0], changedPointers: i[1], pointerType: At, srcEvent: t });
      }
    },
  });
    ...
    function t(t) {
      ...
      'swipeup' === t.type || 40 === t.keyCode || t > 0
        ...
        : ('swipedown' === t.type || 38 === t.keyCode || 0 > t) &&
          (0 !== s ? ((o = s - 1), e(o), i(s, o, r)) : ((o = r), e(o), i(s, o, r)));
    }
    function e(t) {
    ...
    function n() {
      $('.header--nav-toggle').click(function () {
        $('.perspective').addClass('perspective--modalview'),
          ...
          $('.outer-nav, .outer-nav li, .outer-nav--return, .outer-image, .outer-image li').addClass('is-vis');
      }),
        $('.outer-nav--return, .outer-nav li').click(function () {
          $('.perspective').removeClass('effect-rotate-left--animate'),
            ...
            $('.outer-nav, .outer-nav li, .outer-nav--return, .outer-image, .outer-image li').removeClass('is-vis');
        });
    }
    function s() {
